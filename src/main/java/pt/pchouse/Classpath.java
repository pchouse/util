...
/**
 *  A deivated work of
 *  @see https://github.com/cenote/jasperstarter/blob/master/src/main/java/de/cenote/tools/classpath/ApplicationClasspath.java
...
public class Classpath {
 ...
 if any.
    ...
    public static File getAppBaseDirFromThis() throws URISyntaxException {
        URL baseUrl = Classpath.class.getProtectionDomain().getCodeSource().getLocation();
        File baseDir;
    ...
    public static File getAppBaseDirFromClasspath() throws URISyntaxException {
        URL baseUrl = ((URLClassLoader) Classpath.class.getClassLoader()).getURLs()[0];
        File baseDir;
        if (baseUrl.getAuthority() != null) {
            // workaroud Windows UNC path problems
            URI uri;
